...
export async function usuarioDaSessao(bd, token) {
  ...
  return bd.get(
    `SELECT u.id, u.nome, u.email, u.papel, u.turma_id, u.matricula, u.instituicao, u.pode_convidar, u.avisar_email, u.email_aviso, t.nome AS turma_nome, t.codigo AS turma_codigo
       FROM sessoes s
